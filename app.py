...
with tab2:
    ...
    if not df_raw.empty:
        ...
        if selected_rows:
            ...
            # عرض PDF في نفس الصفحة - باستخدام iframe مع طريقة مختلفة
            if row['file_name']:
                ...
                if os.path.exists(file_path):
                    ...
                    # عرض PDF باستخدام Google Docs Viewer (الحل السحري)
                    pdf_viewer_url = f"https://docs.google.com/viewer?url=data:application/pdf;base64,{base64_pdf}&embedded=true"
                    
                    # استخدام iframe مع Google Docs Viewer
                    st.markdown(f'''
                        <iframe 
                            src="https://docs.google.com/viewer?url=data:application/pdf;base64,{base64_pdf}&embedded=true" 
                            width="100%" 
                            height="800px" 
                    ...
                    st.caption("💡 إذا لم يظهر الملف، اضغط على زر التحميل أدناه")
